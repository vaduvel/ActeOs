        ...
        *,
        ...
        for record in self.catalog.records:
            if apply_hard_filters and not record.is_active:
                continue
            available = jurisdiction_available_ids is None or record.id in jurisdiction_available_ids
            if apply_hard_filters and jurisdiction_available_ids is not None and not available:
                continue
            score, signals = self._score(
                ...
                jurisdiction_available=bool(available),
