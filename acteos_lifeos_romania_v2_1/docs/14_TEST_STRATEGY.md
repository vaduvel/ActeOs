...
## 3A. Intent discovery tests

- exact title și alias;
- cu/fără diacritice;
- abrevieri aprobate;
- ambiguitate și margin thresholds;
- negative aliases;
- no-result;
- intent retras/nepublicat;
- jurisdiction availability;
- offline index parity;
- semantic adapter returning unknown ID;
- deterministic ordering și catalog version;
- raw query absent din logs/analytics.

## 4. Rule fixture matrix

Pentru fiecare intent R1:
...
Minimum 20 fixtures per intent family înainte de release; demersurile complexe pot avea mult mai multe.
