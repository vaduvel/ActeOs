...
1. **Intent-first discovery, event-aware composition:** utilizatorul pornește de la ce vrea să rezolve; evenimentele de viață coordonează bundle-uri și recomandări conexe.
...
11. **Canonical intent gate:** search/AI poate returna numai `intent_type_id` publicat și confirmat de utilizator.
...
- Discovery: normalizare și ranking determinist; sponsorship-ul nu intră în scor.
...
- Nu crea automat un caz din query și nu păstra query brut sensibil în analytics.
