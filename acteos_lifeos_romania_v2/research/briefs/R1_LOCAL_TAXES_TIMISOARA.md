# Deep Research Brief — Taxe locale și certificat fiscal Timișoara

## Event

`ro.life.local_tax_certificate / declare_vehicle_local_tax / remove_vehicle_local_tax`
...
- certificat fiscal persoană fizică/juridică
- declarare/radiere auto
- declarare imobil
- termene, formulare, semnături și valabilitate
- plată și canale
- procura/reprezentare

## Official source targets

- Direcția Fiscală a Municipiului Timișoara
- HCL/regulamente locale
- Ghișeul.ro unde se aplică
