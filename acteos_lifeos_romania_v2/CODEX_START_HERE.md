...
3. Citește documentele în ordinea din `README.md`.
...
- pentru schimbări de reguli, vertical slices, import de research și release, urmează skill-ul corespunzător din `.agents/skills/`.
