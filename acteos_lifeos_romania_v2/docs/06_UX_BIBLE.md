...
- titlu: „Ce s-a întâmplat?”;
- input text/voice;
- 6–8 evenimente frecvente locale;
- card „Următorul lucru de făcut” dacă există Journey activ;
- documente/termene apropiate;
- acces discret la căutarea după procedură.

Home nu este dashboard de date. Este rampă de acțiune.
...
- status și numele evenimentului;
- **Următorul pas**;
...
## 12. Flow canonic: Ana s-a mutat

1. Ana scrie „m-am mutat în Timișoara”.
...
Nu trimitem textul introdus, adrese, nume, document type+holder sau imagini. Evenimentele analytics folosesc ID-uri de taxonomie și stări agregabile. Orice replay/screen recording este dezactivat pe ecrane cu date sensibile.
