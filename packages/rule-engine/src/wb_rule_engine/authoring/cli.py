"""CLI: run golden fixtures across governed authoring batches.
    ...
    python -m wb_rule_engine.authoring [INBOX_DIR]
    wb-golden [INBOX_DIR]

Exits non-zero if any fixture fails. INBOX_DIR defaults to the LifeOS Romania
research inbox relative to the repo root.
"""
...
DEFAULT_INBOX = "docs/product/lifeos-romania/research/inbox"
