# Batch 16 — Utilities
# Evenimente: change_heat_holder, change_internet_holder, utility_new_connection, utility_connection_construction
...
LIVRABIL: Pentru FIECARE din cele 4 evenimente de mai jos, intoarce exact 5 fisiere (event_card.md, source_claims.yaml, rules.yaml, fixtures/golden.yaml, gaps.md). Delimiteaza fiecare eveniment cu o linie `===`.

Evenimente de cercetat (toate 4 in aceeasi rulare):
- ro.life.change_heat_holder
- ro.life.change_internet_holder
- ro.life.utility_new_connection
- ro.life.utility_connection_construction

TOTAL: 24 fisiere pentru acest batch (4 evenimente × 6 fisiere).
...
IMPORTANT: Nu sari peste niciun eveniment. Toate 4 trebuie livrate cu cate 20+ fixtures fiecare. Respecta schemele si enum-urile din documentatia de referinta.